...
export default class Snake {
  ...
  render(){
    if(!this.gameOver){
      ...
      this.svg.children[this.tail].setAttribute("fill", "#0f4010");
      //Actualizamos la posicion de cada parte del cuerpo.
      for(var i = 0;i < this.body.length;i++){
        this.svg.children[this.body[i]].setAttribute("fill", "#99ff33");
      }
    }
  }
  ...
  restart() {
    ...
    for(var i = 0; i < 3072;i++){
      this.svg.children[i].setAttribute("fill", "#0f4010");
    }
  }
}
