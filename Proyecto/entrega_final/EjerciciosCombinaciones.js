window.addEventListener("load", function(evt) {
    ...
    this.info3.textContent = `Recordemos que en las combinaciones no importa el orden en el
                              que acomodemos a los elementos por lo que podemos formar combinaciones con repeticion.`;
